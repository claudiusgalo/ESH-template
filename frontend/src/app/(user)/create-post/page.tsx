// "use client"
// import { useCreatePostMutation, useMeQuery, } from "@/app/graphql/gql/graphql";
...
//               // await createPost({ input: inputValues });
//               // console.log(inputValues);
//               // router.push("/");

//               try {
//                 const { data, error } = await createPost({ input: inputValues });
//                 if (error) {
//                   console.error("Mutation error:", error);
//                 } else if (data) {
//                   console.log("Mutation success:", data.createPost);
//                 }
//                 router.push("/");
//               } catch (err) {
...
//                   <div key={index} className="container aspect-square">
        ...
        <div className="bg-grey-56 rounded-md shadow-lg p-6 border-2 border-orange-55">
          ...
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              console.log('data: ', data?.createPost.imageUrls);
            }}
          >
            <Form>
              <div>
