...
/* harmony import */ var _errors_error_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./errors/error_handler */ "./errors/error_handler.js");
/* harmony import */ var _errors_general_missing_parameter_error__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./errors/general/missing_parameter_error */ "./errors/general/missing_parameter_error.js");
/* harmony import */ var _services_address_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/address_service */ "./services/address_service.js");
/* harmony import */ var _services_api_key_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/api_key_service */ "./services/api_key_service.js");
/* harmony import */ var _services_batch_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/batch_service */ "./services/batch_service.js");
/* harmony import */ var _services_beta_carrier_metadata__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./services/beta_carrier_metadata */ "./services/beta_carrier_metadata.js");
...
const DEFAULT_HEADERS = {
  ...
  'User-Agent': `EasyPost/v2 NodejsClient/${_package_json__WEBPACK_IMPORTED_MODULE_2__.version} Nodejs/${process.versions.node} OS/${os__WEBPACK_IMPORTED_MODULE_0___default().platform()} OSVersion/${os__WEBPACK_IMPORTED_MODULE_0___default().release()} OSArch/${os__WEBPACK_IMPORTED_MODULE_0___default().arch()}`
};
 ...
 */
const SERVICES = {
  Address: _services_address_service__WEBPACK_IMPORTED_MODULE_6__["default"],
  ApiKey: _services_api_key_service__WEBPACK_IMPORTED_MODULE_7__["default"],
  Batch: _services_batch_service__WEBPACK_IMPORTED_MODULE_8__["default"],
  BetaCarrierMetadata: _services_beta_carrier_metadata__WEBPACK_IMPORTED_MODULE_9__["default"],
...
class EasyPostClient {
  constructor(key, options = {}) {
    ...
    if (!key && !useProxy) {
      throw new _errors_general_missing_parameter_error__WEBPACK_IMPORTED_MODULE_5__["default"]({
        message: util.format(_constants__WEBPACK_IMPORTED_MODULE_3__["default"].MISSING_REQUIRED_PARAMETER, 'API Key')
      });
    }
    this.key = key;
  ...
  async _request(path = '', method = METHODS.GET, params = {}, headers = {}) {
    ...
    try {
      ...
      if (error.response && error.response.body) {
        throw _errors_error_handler__WEBPACK_IMPORTED_MODULE_4__["default"].handleApiError(error.response);
      } else {
        throw error;
      }
    }
...
/* harmony export */ });
/* harmony import */ var _api_redirect_error__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api/redirect_error */ "./errors/api/redirect_error.js");
/* harmony import */ var _api_unauthorized_error__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api/unauthorized_error */ "./errors/api/unauthorized_error.js");
/* harmony import */ var _api_unknown_api_error__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./api/unknown_api_error */ "./errors/api/unknown_api_error.js");
/* harmony import */ var _api_payment_error__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api/payment_error */ "./errors/api/payment_error.js");
/* harmony import */ var _api_not_found_error__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./api/not_found_error */ "./errors/api/not_found_error.js");
/* harmony import */ var _api_method_not_allowed_error__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./api/method_not_allowed_error */ "./errors/api/method_not_allowed_error.js");
/* harmony import */ var _api_timeout_error__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./api/timeout_error */ "./errors/api/timeout_error.js");
/* harmony import */ var _api_invalid_request_error__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./api/invalid_request_error */ "./errors/api/invalid_request_error.js");
/* harmony import */ var _api_rate_limit_error__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./api/rate_limit_error */ "./errors/api/rate_limit_error.js");
/* harmony import */ var _api_internal_server_error__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./api/internal_server_error */ "./errors/api/internal_server_error.js");
/* harmony import */ var _api_service_unavailable_error__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./api/service_unavailable_error */ "./errors/api/service_unavailable_error.js");
/* harmony import */ var _api_gateway_timeout_error__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./api/gateway_timeout_error */ "./errors/api/gateway_timeout_error.js");
/* harmony import */ var _api_forbidden_error__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./api/forbidden_error */ "./errors/api/forbidden_error.js");
/* harmony import */ var _easypost_error__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./easypost_error */ "./errors/easypost_error.js");
...
class ErrorHandler {
  ...
  static handleApiError(error) {
    ...
    try {
      ...
      const errorParams = {
        message: _constants__WEBPACK_IMPORTED_MODULE_14__["default"].ERROR_DESERIALIZATION,
        code: 'ERROR_DESERIALIZATION_ERROR'
      };
      return new _easypost_error__WEBPACK_IMPORTED_MODULE_13__["default"](errorParams);
    }
    if (statusCode >= 300 && statusCode < 400) {
      return new _api_redirect_error__WEBPACK_IMPORTED_MODULE_0__["default"](errorParams);
    }
    switch (statusCode) {
      case 401:
        return new _api_unauthorized_error__WEBPACK_IMPORTED_MODULE_1__["default"](errorParams);
      case 402:
        return new _api_payment_error__WEBPACK_IMPORTED_MODULE_3__["default"](errorParams);
      case 403:
        return new _api_forbidden_error__WEBPACK_IMPORTED_MODULE_12__["default"](errorParams);
      case 404:
        return new _api_not_found_error__WEBPACK_IMPORTED_MODULE_4__["default"](errorParams);
      case 405:
        return new _api_method_not_allowed_error__WEBPACK_IMPORTED_MODULE_5__["default"](errorParams);
      case 408:
        return new _api_timeout_error__WEBPACK_IMPORTED_MODULE_6__["default"](errorParams);
      case 422:
        return new _api_invalid_request_error__WEBPACK_IMPORTED_MODULE_7__["default"](errorParams);
      case 429:
        return new _api_rate_limit_error__WEBPACK_IMPORTED_MODULE_8__["default"](errorParams);
      case 500:
        return new _api_internal_server_error__WEBPACK_IMPORTED_MODULE_9__["default"](errorParams);
      case 503:
        return new _api_service_unavailable_error__WEBPACK_IMPORTED_MODULE_10__["default"](errorParams);
      case 504:
        return new _api_gateway_timeout_error__WEBPACK_IMPORTED_MODULE_11__["default"](errorParams);
      default:
        return new _api_unknown_api_error__WEBPACK_IMPORTED_MODULE_2__["default"](errorParams);
    }
  }
}
...
class Utils {
  ...
  validateWebhook(eventBody, headers, webhookSecret) {
    var _headers$XHmacSigna;
    let webhook = {};
    const easypostHmacSignature = (_headers$XHmacSigna = headers['X-Hmac-Signature']) !== null && _headers$XHmacSigna !== void 0 ? _headers$XHmacSigna : null;
