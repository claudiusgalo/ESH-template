...
let UserResolver = class UserResolver {
    ...
    async forgotPassword(email, { redis }) {
        ...
        await redis.set(constants_1.FORGOT_PASSWORD_PREFIX + token, user.id, 'EX', 1000 * 60 * 60 * 24);
        await (0, sendMail_1.sendEmail)(email, `<a href="http://localhost:3000/change-password/${token}"> reset password </a>`);
        return true;
    }
    me({ req }) {
